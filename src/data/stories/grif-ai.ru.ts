...
export const ru: CaseStory = {
  ...
  /* фирменные материалы продукта и фото разделяют главы: длинную страницу читают скроллом, и ей нужны паузы */
  interludes: [
    { after: "brief", focus: "50% 62%", image: { src: "cases/grif-ai/brand-visual.webp", w: 1100, h: 1100, caption: "Ключевой визуал продукта: строка запроса и подсказки над металлическим крылом", kind: "brand" } },
    { after: "approach", image: { src: "cases/grif-ai/atmosphere.webp", w: 1172, h: 1580, caption: "Тёмная ткань и узкая полоса синего света", kind: "photo" } },
    { after: "decisions", focus: "50% 46%", image: { src: "cases/grif-ai/brand-wing.webp", w: 1100, h: 1100, caption: "Знак продукта: крыло грифа и три опоры — проактивный ИИ, интерфейс, работа с данными", kind: "brand" } },
  ],
  research: {
