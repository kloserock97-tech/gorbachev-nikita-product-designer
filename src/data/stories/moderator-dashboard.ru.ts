  ...
  gallery: [
    {
      ...
      image: img(F + "moderator-queue.webp", 1440, 1156, "Очередь пользователей с фильтрами, ответственными, статусами и жалобами", "hero"),
      spots: [
    ...
    },
    {
      ...
      before: img(F + "moderator-profile.webp", 1440, 861, "Профиль пользователя: что он писал и что с ним связано"),
      after: img(F + "moderator-confirm.webp", 1440, 861, "Подтверждение перед тем, как модератор берёт обращение в работу"),
