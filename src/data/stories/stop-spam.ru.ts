    ...
    items: [
      {
        ...
        why: "Человек соглашается охотнее, когда видит, сколько осталось. Шкала показывает конец пути.",
        basis: "Разбор пути по шагам и гипотеза 03. Правило Нильсена: система показывает, на каком вы шаге.",
      ...
      },
      {
        ...
        why: "Доступ просят вперёд, а пользу обещают потом. Счётчик даёт пользу сразу, до разрешения.",
        basis: "Сверка с обещанием в сторе и гипотеза 02.",
      },
      {
        id: "why",
        ...
        why: "Системное окно спрашивает и не объясняет. Экран перед ним отвечает на вопрос «зачем вам мои звонки».",
        basis: "Интервью с разработкой: менять можно только экран перед системным окном; гипотеза 01.",
      },
      {
        id: "rhythm",
        ...
        why: "Второе разрешение человек проходит уже по знакомой дорожке, а не разбирается заново.",
        basis: "Правило Нильсена о единообразии: одинаковые шаги узнаются без чтения.",
      },
    ],
  },
  results: {
  ...
  gallery: [
    {
      ...
      images: [
        img(F + "spam-welcome.webp", 402, 874, "Первый экран: сначала польза приложения, потом просьбы о доступе", "hero"),
        img("cases/stop-spam/01.webp", 1300, 2642, "Статистика: уровень защиты и счётчики заблокированного", "device"),
        img(F + "spam-sms-setup.webp", 402, 874, "Настройка фильтра SMS, разложенная на пять понятных шагов"),
      ],
    },
  ],
  deepDives: [],
