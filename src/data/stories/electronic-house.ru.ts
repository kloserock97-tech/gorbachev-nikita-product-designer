    ...
    items: [
      {
        ...
        why: "Жилец заходит заплатить или подать заявку. Первое, что он видит, должно быть об этом.",
        basis: "Разбор по правилам Нильсена и срочный горизонт матрицы правок. Закон Хика: чем больше всего на экране, тем дольше выбор.",
      },
      {
        id: "myhome",
        ...
        why: "Пустой раздел читается как сломанный. Статус по адресу сразу говорит, на каком человек шаге.",
        basis: "Карта проблем, строка про информативность. Правило Нильсена: система показывает, что с ней происходит.",
      },
      {
        id: "chats",
        ...
        why: "Писать консьержу в чат дома неловко и бесполезно. Название группы отвечает, кто прочитает.",
        basis: "Карта проблем, строка про навигацию.",
      },
      {
        id: "errors",
        ...
        why: "Код ошибки ничего не говорит жильцу. Он идёт писать плохой отзыв, потому что других вариантов не видит.",
        basis: "Данные команды исследований и матрица правок: самое дешёвое и самое срочное. Правило Нильсена: ошибка объясняет причину и подсказывает выход.",
      },
    ],
  },
  results: {
