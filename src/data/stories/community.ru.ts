    ...
    methods: [
      {
        ...
        image: img(C + "07.webp", 1820, 1010, "Сравнение конкурентов по одиннадцати функциям: зелёным отмечено то, что есть у всех, красным то, чего рынку не хватает", "detail"),
      },
      {
    ...
    items: [
      {
        ...
        why: "Человек не должен заново разбираться на каждой странице. У одного действия одно место и один вид.",
        basis: "Конкурентный разбор и проверка по правилам Нильсена: единообразие, чтобы одно и то же везде выглядело одинаково.",
      },
      {
        id: "posts",
        ...
        why: "Если главное действие приходится искать, его не делают. Написать историю и ответить на неё видно сразу.",
        basis: "Конкурентный разбор: посты и комментарии есть у каждого сервиса из сравнения по одиннадцати функциям.",
        image: img(C + "03.webp", 876, 862, "Форма «Расскажите свою историю»: заголовок, текст, до десяти изображений, и история уходит на проверку"),
      },
      {
        id: "older",
        ...
        why: "Сайт про городские истории, и рассказывают их в основном люди постарше. Сложный фильтр для них равен закрытой двери.",
        basis: "Портрет пользователя и опрос удовлетворённости (CSI). Закон Хика: чем больше вариантов на экране, тем дольше человек выбирает.",
      },
      {
        id: "ds",
        ...
        why: "Читать будут по десять минут подряд. Шрифт и контраст решают, устанут глаза или нет.",
        basis: "Портрет читателя старшего возраста и рекомендации по доступности (WCAG) к контрасту текста.",
  ...
  gallery: [
    {
      ...
      image: img(C + "01.webp", 1440, 788, "Лента первой версии: статьи редакции и истории жителей в одном потоке", "hero"),
      spots: [
        { x: 46.3, y: 15.5, text: "Рубрики стоят одной строкой. Разбираться в панели фильтров не нужно", decision: "older" },
        { x: 10.4, y: 54.4, text: "Комментарии и «поделиться» есть на каждой карточке", decision: "posts" },
        { x: 46.3, y: 76.4, text: "Одно и то же действие выглядит одинаково везде", decision: "pattern" },
      ],
    },
    {
      kind: "bento",
      ...
      images: [
        img(C + "02.webp", 1440, 860, "Страница истории: теги, авторы и похожие материалы под рукой"),
        img(C + "04.webp", 1440, 880, "Страница «О проекте»: зачем сайт нужен, и фирменная бегущая строка"),
        img(C + "05.webp", 1440, 1230, "Обратная связь: вопрос в поддержку и идея отправляются из одного окна, соцсети рядом"),
      ],
    },
  ],
  deepDives: [],
