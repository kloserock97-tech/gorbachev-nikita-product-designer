    ...
    decisions: {
      ...
      items: [
        ...
        },
        {
          ...
          image: img(A + "05.webp", 1440, 900, "The \"Risk not applicable\" window: the button becomes available only after the reason is written", "detail"),
        },
        {
          id: "auto",
          ...
          image: img(A + "03.webp", 1440, 900, "Going through the archive: you see how much is done, and grey placeholders of future risks in place of a spinner"),
          deepDive: "filter-progress",
        },
        {
          id: "unsaved",
    ...
    gallery: [
      {
        ...
        image: img(A + "t-registry-assessments.webp", 1440, 900, "Risk assessment list: filter labels, loss amounts on every card and the switch for short numbers"),
        spots: [
          { x: 90.2, y: 13.2, text: "The switch for short numbers: amounts read as orders of magnitude", decision: "numbers" },
          { x: 28.3, y: 26.4, text: "The chosen filters show as labels and can be removed one by one", decision: "filter" },
          { x: 89.2, y: 34.4, text: "The name of the chosen sorting is written on the button", decision: "sort" },
          { x: 52.2, y: 51.4, text: "Four loss amounts per card: forty numbers on ten cards", decision: "numbers" },
        ],
      },
      {
        kind: "spot",
        title: "The list of agents: the summary answers before you can count the rows",
        image: img(A + "01.webp", 1440, 900, "The shared list of AI agents: summary on top, list below"),
        spots: [
          { x: 35, y: 32.9, text: "Total, assessed, in assessment, and the growth over the month", decision: "summary" },
          { x: 52.2, y: 45.8, text: "The split by risk level on a separate line", decision: "summary" },
          { x: 89, y: 61.9, text: "The status of a version shows right in the list, no need to ask" },
        ],
      },
      {
        kind: "compare",
        title: "The filter: option 1 against option 2",
        before: img(A + "t-filter-v1-panel-set.webp", 500, 900, "Option 1: a panel where the filter works at once", "detail"),
        after: img(A + "t-filter-v2-panel.webp", 500, 1140, "Option 2: choosing several values and a \"Show\" button", "detail"),
        labels: ["Works at once · chosen", "\"Show\" button"],
      },
      {
        kind: "film",
        title: "Editing a risk: level, reasons and a required comment",
        image: img(A + "07.webp", 1200, 1800, "Risk editing form: level, reasons and the risk manager's required comment"),
      },
      {
        kind: "bento",
        title: "More screens",
        images: [
          img(A + "02.webp", 1440, 900, "An agent card before assessment: empty, but you can see what is missing"),
          img(A + "t-sort-open.webp", 1440, 900, "The sorting menu with four items", "detail"),
          img(A + "t-agent-card-generating.webp", 910, 500, "Uploading documents from the agent card", "detail"),
          img(A + "t-registry-shimmer.webp", 1180, 470, "Uploading documents from the shared list", "detail"),
        ],
      },
    ],
