...
const cases: CaseItem[] = [
  { id: "grif-ai", title: "GRIF AI", subtitle: "An assistant that brings ready-made actions. One designer: me", tag: "AI assistant · 2026", kind: ["web"], look: { stage: ["#eef3fb", "#d3e1f6"], ink: "#14213d", accent: "#2f5fd0", object: { w: 1.18, x: -0.06, y: -0.03, ratio: 888 / 851 }, screen: { src: "cases/grif-ai/05.webp", w: 1024, h: 640, device: "browser" } }, brand: "grif.svg" },
