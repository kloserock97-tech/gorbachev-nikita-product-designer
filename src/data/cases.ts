...
const cases: CaseItem[] = [
  ...
  { id: "design-lead", title: "Nobody Appointed Me", subtitle: "A year leading four designers with no title: briefs stopped arriving as one line", tag: "Design lead · Sber · 2025–2026", kind: ["web"], look: { stage: ["#f6f1e7", "#e7dcc6"], ink: "#2a2318", accent: "#a9752b", object: { w: 0.62, x: 0.19, y: -0.05, ratio: 900 / 1156, avif: false } }, stat: { value: "~1 year", label: "running the design team with nobody appointed" }, brand: "sber.svg" },
...
const ru: Record<string, Ru> = {
  ...
  "design-lead": { title: "Никто не назначал", subtitle: "Год вёл четверых дизайнеров без должности: задачи перестали приходить одной строкой", tag: "Дизайн-лид · Сбер · 2025–2026", stat: { value: "~1 год", label: "вёл команду, пока никого не назначили" } },
