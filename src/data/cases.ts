...
const cases: CaseItem[] = [
  ...
  { id: "design-lead", title: "Led Before the Title", subtitle: "A year leading four designers before the title existed: briefs stopped arriving as one line", tag: "Design lead · Sber · 2025–2026", kind: ["web"], look: { stage: ["#f6f1e7", "#e7dcc6"], ink: "#2a2318", accent: "#a9752b", object: { w: 0.62, x: 0.19, y: -0.05, ratio: 900 / 1156, avif: false } }, stat: { value: "~1 year", label: "leading the design team before the title existed" }, brand: "sber.svg" },
...
const ru: Record<string, Ru> = {
  ...
  "design-lead": { title: "Взял и повёл", subtitle: "Год вёл четверых дизайнеров ещё до должности: задачи перестали приходить одной строкой", tag: "Дизайн-лид · Сбер · 2025–2026", stat: { value: "~1 год", label: "вёл команду ещё до того, как появилась должность" } },
