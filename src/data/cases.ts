...
const cases: CaseItem[] = [
  ...
  { id: "design-lead", title: "Design Got a Seat", subtitle: "Design out of service work and into product calls: briefs with a goal, review before engineering", tag: "Design lead · Sber · 2025–2026", kind: ["web"], look: { stage: ["#f6f1e7", "#e7dcc6"], ink: "#2a2318", accent: "#a9752b", object: { w: 0.62, x: 0.19, y: -0.05, ratio: 900 / 1156, avif: false } }, stat: { value: "~1 year", label: "in which design moved into product decisions" }, brand: "sber.svg" },
...
const ru: Record<string, Ru> = {
  ...
  "design-lead": { title: "Дизайн получил голос", subtitle: "Дизайн перестал быть оформлением в конце: задача с целью, ревью до разработки, место в решениях", tag: "Дизайн-лид · Сбер · 2025–2026", stat: { value: "~1 год", label: "за который дизайн вошёл в решения по продукту" } },
